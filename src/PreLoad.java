...
public class PreLoad extends JFrame {
	 ...
	 */
	public PreLoad() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(PreLoad.class.getResource("/img/bg.png")));
	...
	public class Imagen extends JPanel {
		...
		public void paint(Graphics grafico) {
			...
			ImageIcon Img = new ImageIcon(getClass().getResource("/img/bg1.png"));
			...
			grafico.drawString("taller Pepito", 510, 150);// texto a escribir con las cordenasdas en x y
			grafico.drawString("Sistema de Gestiòn de Repuestos", 510, 230);
			setOpaque(false);
